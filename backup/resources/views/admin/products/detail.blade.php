                            ...
                            <div class="col-xs-12">
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        ...
                                        {!! Form::open(array('url' =>'admin/products/publish', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                        {!! Form::hidden('pro_id', $result['product'][0]->products_id, array('class'=>'form-control', 'id'=>'pro_id')) !!}
                                        {!! Form::hidden('vendor_id', $result['product'][0]->vendor_id, array('class'=>'form-control', 'id'=>'vendor_id')) !!}
                                        <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-8">
                                                        <select class="form-control" name="products_status">
                                                            <option value="2" @if($result['product'][0]->products_status==2) selected @endif >{{ trans('labels.new') }}</option>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-md-6">
                                                <div class="form-group" id="tax-class">
                                                    <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.ProductsQuantity') }} <span style="color:red;">*</span></label>
                                                    <div class="col-sm-10 col-md-8">
                                                        {!! Form::text('products_quantity', $result['product'][0]->products_quantity, array('class'=>'form-control number-validate field-validate', 'id'=>'products_quantity')) !!}
                                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        ...
                                                        <div id="imageselected" style="display: none;">
                                            ...
                                            <div class="col-xs-12 col-md-6">
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.percentage') }} (%)</label>
                                                    <div class="col-sm-10 col-md-8">
                                                        <input type="text" name="percentage" class="form-control" value="{{$result['product'][0]->percentage}}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        @if(isset($result['vendor_data']))
                                        <div class="row">
                                            @if(count($result['vendor_data']) > 0)
                                            <div class="col-xs-12 col-md-6">                                                
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.Vendor Info') }}</label>
                                                    <div class="col-sm-10 col-md-8">
                                                        <p>{{ $result['vendor_data'][0]->vendor_name }}</p>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.Owner Info') }}</label>
                                                    <div class="col-sm-10 col-md-8">
                                                        <p>{{ $result['vendor_data'][0]->first_name }} {{ $result['vendor_data'][0]->last_name }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-8">
                                                        <p>{{$result['vendor_data'][0]->vendor_email}}</p>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.Phone') }}</label>
                                                    <div class="col-sm-10 col-md-8">
                                                        <p>{{$result['vendor_data'][0]->vendor_phone}}</p>
                                                    </div>
                                                </div>
                                            </div>
                                            @endif
                                            
                                            @if($result['product'][0]->updated_by_vendor == 1)
                                            <h3>{{ trans('labels.Updated info') }}</h3>

                                            <div class="col-xs-12 col-md-6">                                            
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.Quantity') }}</label>
                                                    <div class="col-sm-10 col-md-8">
                                                        <p>{{ $result['product'][0]->updated_quantity }}</p>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.Updated At') }}</label>
                                                    <div class="col-sm-10 col-md-8">
                                                        <p>{{ date('Y-m-d',strtotime($result['product'][0]->updateddate)) }}</p>
                                                    </div>
                                                </div>                                                
                                            </div>

                                            <div class="col-xs-12 col-md-6">
                                                @php $imagess = json_decode($result['product'][0]->updated_images); @endphp
                                                @if(count($imagess) > 0)
                                                    <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.Images') }}</label>
                                                    <div class="col-sm-10 col-md-8">
                                        ...
                                        <!-- /.box-body -->
                                        <div class="box-footer text-center" style="width: 55%; margin: 0 auto;">
                                            <!-- <button type="submit" class="btn btn-primary pull-left" id="normal-btn">{{ trans('labels.Accept') }} <i class="fa fa-angle-right 2x"></i></button> -->
                                            @if($result['product'][0]->products_status == 2)
                                            <button class="btn btn-primary pull-left" type="submit">{{ trans('labels.PublishProduct') }}</button>
                                            <a class="btn btn-danger" onclick="decline({{$result['product'][0]->products_id}})">{{ trans('labels.DeclineProduct') }}</a>
                                            @elseif($result['product'][0]->update_request_status == 2)
                                            <a class="btn btn-success pull-left" onclick="acceptchange({{$result['product'][0]->products_id}})">{{ trans('labels.Accept') }}</a>
                                            <a class="btn btn-danger" onclick="declinechange({{$result['product'][0]->products_id}})">{{ trans('labels.Decline') }}</a>
                                            @endif
                                            <a class="btn btn-default pull-right" href="{{ URL::to('admin/products/display')}}">{{ trans('labels.back') }}</a>
                                        </div>
