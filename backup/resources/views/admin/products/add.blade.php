                                ...
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-md-6">
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.Vendors') }}<span style="color:red;">*</span></label>
                                                    <div class="col-sm-10 col-md-8">
                                                        <select class="form-control field-validate" name="vendor_id">
                                                            <option value="">{{ trans('labels.Choose One') }}</option>
                                                            @foreach($result['vendors'] as $vendor)
                                                            <option value="{{$vendor->vendor_id}}">{{ $vendor->vendor_name }}</option>
                                                            @endforeach    
                                                        </select><span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                                            {{ trans('labels.Select Vendor') }}.</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-md-6">
                                                <div class="form-group" id="tax-class">
                                                    ...
                                                    <div class="col-sm-10 col-md-8">
                                                        {!! Form::text('products_quantity', 20, array('class'=>'form-control number-validate field-validate', 'id'=>'products_quantity')) !!}
                                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-8">
                                                        <input type="text" name="percentage" class="form-control field-validate" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
