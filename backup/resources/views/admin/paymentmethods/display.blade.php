                  ...
                  <div class="box-body">
                    <form enctype="multipart/form-data" class='form-validate'
                      ...
                      <div class="row">
                        <div class="col-xs-12">
                          <div class="form-group">
                            <label for="shippingEnvironment" class="col-sm-2 col-md-2 control-label"
                              style="">{{ trans('labels.Enviroment') }}</label>
                            <div class="col-sm-10 col-md-4">
                              @if($id == 12)
                              <label class=" control-label">
                                <input type="radio" name="environment" value="1" class="flat-red"
                                  @if($result['methods']['payment_methods']['environment']==1) checked @endif>
                                &nbsp;{{ trans('labels.Sanbox') }}
                              </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                              <label class=" control-label">
                                <input type="radio" name="environment" value="0" class="flat-red"
                                  @if($result['methods']['payment_methods']['environment']==0) checked @endif>
                                &nbsp;{{ trans('labels.Live') }}
                              </label>
                              @else
                              <label class=" control-label">
                              ...
                              <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0; display: none">{{ trans('labels.BraintreeAccountTypeText') }}</span>
                              <br>
                            </div>
                          </div>
                          </br>
                        ...
                        @foreach($result['methods']['method_keys'] as $res)
                          ...
                          @if($res->keyname != 'paymentcurrency')
                            ...
                            <div class="col-xs-6" style="margin-bottom: 10px;">
                              <div class="form-group">
                                <label for="name" class="col-sm-2 col-md-4 control-label">{{ trans('labels.'.$res->keyname) }}</label>
                                <div class="col-sm-10 col-md-8">
                                  ...
                                  <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0; display: none">{{ trans('labels.MerchantIDText') }}</span>
                                </div>
                              </div>
                            </div>
                            @else
                            <div class="col-xs-6" style="margin-bottom: 10px;">
                              <div class="form-group">
                                ...
                                <div class="col-sm-10 col-md-8">
                                  ...
                                  @else
                                  <input type="text" name="<?php echo 'field_' .$res->key; ?>" value="{{$res->value}}" class="form-control field-validate">
                                  @endif
                      ...
                      <div class="row">
                        ...
                        <div class="col-xs-6">
                          <div class="form-group">
                            <label for="name" class="col-sm-2 col-md-4 control-label">{{ trans('labels.Name') }}
                            ...
                            <div class="col-sm-10 col-md-8">
                              ...
                              <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.paymentmethodname') }} ({{ $detail['language_name'] }})</span>
                              <span class="help-block hidden" style="display: none">{{ trans('labels.textRequiredFieldMessage') }}</span>
                            </div>
                          </div>
                        </div>
                        @if($id == 9)
                        <div class="col-xs-6">
                          <div class="form-group">
                            <label for="name" class="col-sm-2 col-md-4 control-label">{{ trans('labels.Descriptions') }} ({{ $detail['language_name'] }}) </label>
                            <div class="col-sm-10 col-md-8">
                      ...
                      <div class="row">
                        <div class="box-footer text-center">
                          <button type="submit" class="btn btn-primary payment-checkbox">{{ trans('labels.Submit') }}
                          </button>
                          <a href="{{ URL::to('admin/paymentmethods/index')}}" type="button" class="btn btn-default">{{ trans('labels.back') }}</a>
                        </div>
                      </div>
                    </form>
                    <!-- /.box-footer -->
