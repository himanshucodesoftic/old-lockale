...
<body class="<?php if(!empty(session('direction')) and session('direction')=='rtl') print ' bodyrtl';?> ">
  ...
  <!-- <div id="page"> -->
    ...
    <!-- END NOTIFICATION CONTENT 414px  455-->
    <main style="margin-bottom: 414px; z-index: 2; padding-bottom: 35px;">
  ...
  <!--          @lang('website.This site uses cookies. By continuing to browse the site you are agreeing to our use of-->
  <!--          cookies. Review our')-->
  <!--          <a target="_blank" href="{{ URL::to('/page?name=cookies')}}" class="btn-link">@lang('website.cookies-->
  <!--            information')</a>-->
