...
<!-- BASE CSS -->
<link href="{!! asset('web/css/theme_css/bootstrap.custom.min.cs') !!}" rel="stylesheet">
<link href="{!! asset('web/css/theme_css/style.css') !!}" rel="stylesheet">
<!-- SPECIFIC CSS -->
<link href="{!! asset('web/css/theme_css/home_1.css') !!}" rel="stylesheet">
<!-- <link href="{!! asset('web/css/theme_css/contact.css') !!}" rel="stylesheet"> -->
<!-- <link href="{!! asset('web/css/theme_css/checkout.css') !!}" rel="stylesheet"> -->
<!-- YOUR CUSTOM CSS -->
<link href="{!! asset('web/css/theme_css/custom.css') !!}" rel="stylesheet">
<link href="{!! asset('web/css/theme_css/listing.css') !!}" rel="stylesheet">
