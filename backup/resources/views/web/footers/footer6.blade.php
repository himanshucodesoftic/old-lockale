...
<footer id="footerSix" class="revealed footer-desktop d-none d-lg-block d-xl-block pro-content" style="z-index: 1; position: fixed; bottom: 0px; width: 100%;">
  <div class="container">
    <div class="row">
            ...
            <div class="styled-select lang-selector">
              @if(count($result['languages']) > 1)
                ...
                @if(session('language_name') == "English")                  
                  <button onclick="changeLangHeader({{session('ar_id')}})" style="border: none; color: white; background-color: rgb(255 255 255 / 0%); height: 30px; padding: 0 11px;">االعربية</button>
