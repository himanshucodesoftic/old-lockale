...
class CategoriesController extends Controller
{
  ...
  public function insert(Request $request){
        ...
        $categories_available = $request->categories_available;

        $categories_id = $this->Categories->insert($uploadImage,$date_added,$parent_id,$uploadIcon,$categories_status,$categories_available);
        $slug_flag = false;
  ...
  //  dd($editSubCategory[0]->parent_id);
   ...
   public function update(Request $request){
     ...
     $updateCategory = $this->Categories->updaterecord($categories_id,$uploadImage,$uploadIcon,$last_modified,$parent_id,$slug,$categories_status,$categories_available);
