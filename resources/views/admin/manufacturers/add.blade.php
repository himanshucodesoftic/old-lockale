                                    ...
                                    <!-- /.box-header -->
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.Name') }} (English)<span style="color:red;">*</span></label>
                                            ...
                                            <div class="form-group">
                                                <label for="name_ar" class="col-sm-2 col-md-3 control-label">{{ trans('labels.Name') }} (Arabic)<span style="color:red;">*</span></label>
                                                <div class="col-sm-10 col-md-4">
                                                    {!! Form::text('name_ar',  '', array('class'=>'form-control  field-validate', 'id'=>'name_ar'), value(old('name_ar'))) !!}
                                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.ManufacturerNameExample') }}</span>
                                                    <span class="help-block hidden">{{ trans('labels.textRequiredFieldMessage') }}</span>
                                                </div>
                                            </div>
