      ...
      <div class="row">
        <div class="col-md-12 p-0">
          ...
          <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane fade <?php if($result['top_seller']['success'] != 1 && $result['special']['success']==1) print 'active show'; ?>" id="special">
              <div class="">
                <div style="display: flex;">
            ...
            @if($result['most_liked']['success']==1)
            <div role="tabpanel" class="tab-pane fade <?php if($result['top_seller']['success'] != 1 && $result['special']['success'] != 1 && $result['most_liked']['success'] == 1) print 'active show'; ?>" id="liked">
              <div class="">
                <div style="display: flex;">
