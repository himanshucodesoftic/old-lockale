...
<section class="wishlist-content" style="padding-top: 22px; padding-bottom: 37px;">
  <div class="container">
    <div class="row">
        ...
        <div class="col-12 media-main">
          ...
          <div class="product">
            ...
            <article>
              ...
              <div class="media" style="padding: 20px 2px !important;">
                <img class="img-fluid" style="width: auto !important; height: 160px; border: 1px solid #ddd; margin-right: 1rem;" src="{{asset('').$products->image_path}}" alt="{{$products->products_name}}">
                  ...
                  <div class="row">
                    <div class="col-12 col-md-8  texting">
                      ...
                      <div class="buttons">
                        ...
                        @if($products->defaultStock < 0) <button type="button" class="btn  btn-danger swipe-to-top"
                          ...
                          <a class="btn  btn-secondary swipe-to-top"
                            href="{{ URL::to('/product-detail/'.$products->products_slug)}}">@lang('website.View Detail')</a>
                          @elseif($products->products_type==2)
                          <a href="{{$products->products_url}}" target="_blank"
                            class="btn  btn-secondary swipe-to-top">@lang('website.External Link')</a>
                          @endif
                      </div>
                    </div>
